...
const styles = StyleSheet.create({
  ...
  questionText: {
    fontSize: 24, fontWeight: '700', color: '#0D1B3E',
    textAlign: 'center', lineHeight: 36,
  },
  transcriptBox: {
    backgroundColor: '#fff', borderRadius: 10, padding: 18, width: '100%',
    borderWidth: 1.5, borderColor: '#D4DCF0',
    shadowColor: '#000', shadowOffset: { width: 0, height: 1 },
    shadowOpacity: 0.05, shadowRadius: 4, elevation: 2,
  },
  transcriptText: { fontSize: 20, color: '#2C3550', textAlign: 'center', lineHeight: 30 },
  ...
  micBtn: {
    ...
    backgroundColor: '#2060E0', alignItems: 'center', justifyContent: 'center',
    shadowColor: '#2060E0', shadowOffset: { width: 0, height: 6 },
    shadowOpacity: 0.35, shadowRadius: 14, elevation: 8,
  },
  micBtnActive: { backgroundColor: '#D03020' },
  micIcon: { fontSize: 44, color: '#FFFFFF' },
  guideWrap: { alignItems: 'center', gap: 8 },
  guideText: { fontSize: 20, color: '#6B7A99', textAlign: 'center' },
});
